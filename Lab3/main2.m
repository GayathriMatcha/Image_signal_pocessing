%% Read images
clear;
im11 = imread('ex11.jpg');
im22 = imread('ex22.jpg');
im33 = imread('ex33.jpg');
im1=rgb2gray(im11);
im2=rgb2gray(im22);
im3=rgb2gray(im33);
...
[corresp1, corresp2] = sift_corresp('ex11.jpg','ex22.jpg');
H21 = ransac_self(corresp2, corresp1, epsilon, fraction, n_samples, n_iters);


%% H23 Matrix
[corresp2, corresp3] = sift_corresp('ex22.jpg','ex33.jpg');
