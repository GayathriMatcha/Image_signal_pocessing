function [lambda_best, rmse_vals] = best_lambda(image, blur_param, sigma_n, start_lambda, stop_lambda, step_size, is_motion_blur, reg)
        ...
        !psf2otf(PSF) computes the fast Fourier transform (FFT) of the 
        !point-spread function (PSF) array and creates the optical 
        !transfer function array, OTF, that is not influenced by the PSF off-centering.
        if ~is_motion_blur
